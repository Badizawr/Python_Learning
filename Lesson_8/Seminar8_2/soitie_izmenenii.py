...
def obiedin():
    ...
    f1 = open('D:\Python_Learning\Lesson_8\Seminar8_2\sleSH2_file.txt', 'r', encoding='utf-8')
    f2 = open('D:\Python_Learning\Lesson_8\Seminar8_2\sleSH3_file.txt', 'r', encoding='utf-8')
    # print('content of first file before appending -', f1.read())
    # print('content of second file before appending -', f2.read())
    f1.close()
    f2.close()
    # opening first file in append mode and second file in read mode
    f1 = open('D:\Python_Learning\Lesson_8\Seminar8_2\sleSH2_file.txt', 'a+', encoding='utf-8')
    f2 = open('D:\Python_Learning\Lesson_8\Seminar8_2\sleSH3_file.txt', 'r', encoding='utf-8')
